          ...
          <div class="box">
            ...
            <div class="box-body">
              <fieldset>
                  ...
                  <div class="col-sm-10">
                    <select name='nBahan' id="nBahan" class="selectpicker form-control" data-live-search="true">
                      <?php 
                        ...
                        while($rowProduksiBahan=mysqli_fetch_object($resultBahan)){
                          if(!in_array($rowProduksiBahan->id, $tampungBahan)){
                          echo "<option value='".$rowProduksiBahan->id."|".$rowProduksiBahan->nama."|".$rowProduksiBahan->panjang."'>".$rowProduksiBahan->id." - ".$rowProduksiBahan->nama."
                              </option>";}
                              }?>
                    </select>
                  </div>
                ...
                <div class="form-group">
                  <label for="inputNamaBahan" class="col-sm-2 control-label">Panjang yang Digunakan</label>
                  <div class="col-sm-10">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <fieldset>
                ...
                <form action='#' method='POST'>
                <div class="form-group">
                  <label for="inputNamaBahan" class="col-sm-2 control-label">Nama Barang</label>
                  <div class="col-sm-10">
...
<script>
  ...
  $(document).ready(function() {
      ...
      $("#insert").click(function() {
        ...
        $.ajax({
              type: "POST",
              url: "manage.php?act=inserttanggalproses",
              data: 'tanggal=' + Date.now(),
              success: function(result) {
                $.ajax({ 
                    type: "POST",
                    url: "manage.php?act=ambiltanggalpb",
                    cache: false, 
                    dataType :"JSON",                         
        ...
        function produksi_barang(smth) {        
          for( i = 0 ;i < bahan.length ; i++){
              ...
              $.ajax({
                  type: "POST",
                  url: "manage.php?act=insertbahanprosesbahan",
                  data: 'prosesbahan_id=' + smth+ '&bahan_id=' + tBahan[0]+ '&qty=' + tBahan[3]+ '&jumlah=' + tBahan[2],
                  success: function(result) {
                  }
              });
          }
          for( i = 0 ;i < barang.length ; i++){
              ...
              $.ajax({
                  type: "POST",
                  url: "manage.php?act=insertbarangprosesbahan",
                  data: 'prosesbahan_id=' + smth+ '&barang_id=' + tBarang[0]+ '&qty=' + tBarang[3]+ '&jumlah=' + tBarang[2],
                  success: function(result) {
                  }
              });
          }
