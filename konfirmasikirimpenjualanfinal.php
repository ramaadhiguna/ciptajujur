              ...
              if($row = mysqli_fetch_object($resultPenjualan)){
                echo "<div class=box-body>
                  ...
                  <label for=inputNamaKaryawan class=col-sm-2 control-label>Nomor Nota</label>
                    <div class=col-sm-10>
                      <input type=number value='".$row->idNota."' disabled autofocus class=form-control>
                    </div>
                  </div>
                  <div class=form-group>
                  ...
                  <label for=inputNamaKaryawan class=col-sm-2 control-label>Kontak</label>
                    <div class=col-sm-10>
                      <input type=text value='".$row->kontak."' disabled autofocus class=form-control>
                    </div>
                  </div>
                </div>";
              }
              ...
              echo "<div class=box-body>
                      ...
                      <div class=form-group>
                        <label for=inputUserKaryawan class=col-sm-2 control-label>Jumlah</label>
                          <div class=col-sm-10>
                            <input type=number name=jumlah[] value =".$rowKirim->kuantitas." required autofocus class=form-control>
                          </div>
                      </div>              
                    </div>";
                  }
    ...
    if(cek==0){
      ...
      success: function(result) {
        for( i = 0 ;i < barang.length ; i++){
          $.ajax({
            type: "POST",
            url: "manage.php?act=updatepenjualanbarangfinal",
