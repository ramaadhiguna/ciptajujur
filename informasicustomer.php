...
<head>
  ...
  <title>Customer | Informasi Customer</title>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                while($row = mysqli_fetch_object($resultCustomer)) {
                    ...
                    <td>".$row->kontak."</td>
                    <td>".$row->alamat."</td>
                    <td>"."<a href='#myModal' class='btn btn-default btn-small' id='custId' data-toggle='modal' data-id=".$row->idCustomer.">edit</a></td>";
                    echo "</tr>";
                     } ?>
