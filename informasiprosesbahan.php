...
<head>
  ...
  <title>Produksi | Informasi Produksi</title>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                while($rowProduksi = mysqli_fetch_object($resultInformasiProsesBahan)) {
                    echo "<tr>";
                    echo "<td>".$rowProduksi->date."</td>";
                    echo "<td>".$rowProduksi->idprosesbahan."</td>";
                    echo "<td>";
                    $resultBahan = ProsesBahanBahan($rowProduksi->idprosesbahan);
                    while($rowBahan = mysqli_fetch_object($resultBahan)){
                      echo $rowBahan->nama." : ".$rowBahan->kuantitas." Meter";
                      echo "</br>";
                    }
                    echo "</td>";
                    echo "<td>";
                    $resultBarang = ProsesBahanBarang($rowProduksi->idprosesbahan);
                    while($rowBarang = mysqli_fetch_object($resultBarang)){
                      echo $rowBarang->namaBarang." : ".$rowBarang->kuantitas." Buah";
                      echo "</br>";
                    }
                    echo "</td>";
                    echo "</tr>";
