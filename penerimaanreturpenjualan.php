          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php
                $total = 0;
                while($rowPembelian = mysqli_fetch_object($resultPenjualan)) {
                    echo "<tr>";
                    echo "<td>".$rowPembelian->idNota."</td>";
                    echo "<td>".$rowPembelian->tanggal."</td>";
                    echo "<td>".$rowPembelian->nama."</td>";
                    echo "<td>";
                    $resultBarang = PenjualanBarang($rowPembelian->idNota);
                    while($rowBarang = mysqli_fetch_object($resultBarang)){
                      $total += $rowBarang->kuantitas*$rowBarang->harga;
                      echo $rowBarang->idBarang."-".$rowBarang->namaBarang." = ".$rowBarang->kuantitas;
                      echo "</br>";
                    }
                    echo "</td>";
                    echo "<td><a href=returpenjualan.php?cmd=".$rowPembelian->idNota.">Retur Barang</a></td>";
                    echo "</tr>";
                } ?>
                </tbody>
