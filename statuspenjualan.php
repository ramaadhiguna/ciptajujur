...
<?php
  ...
  if (isset($_SESSION["logkaryawan"])) {
    if ($_SESSION["jabatan"] == "Pemilik" || $_SESSION["jabatan"] == "Penjualan" || $_SESSION["jabatan"] == "Gudang") {
      ?>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                while($rowPenjualan = mysqli_fetch_object($resultPenjualan)) {
                    echo "<tr>";
                    echo "<td>".$rowPenjualan->idNota."</td>";
                    echo "<td>".$rowPenjualan->tanggal."</td>";
                    echo "<td>".$rowPenjualan->nama."</td>";
                    echo "<td>";
                    $resultBarang = PenjualanBarang($rowPenjualan->idNota);
                    ...
                    if($rowPenjualan->saldo == $rowPenjualan->total){
                      ...
                      if($jabatan == "Gudang"){
                        ...
                        echo "<td><a href='#myModal2' class='btn btn-default btn-small' id='custId' data-toggle='modal' data-id=".$rowPenjualan->idNota.">Konfirmasi Refund</a></td>";
                      }
                    }
                    else{
                      if($jabatan == "Gudang"){
                        ...
                        echo "<td><a href='#myModal' class='btn btn-default btn-small' id='custId' data-toggle='modal' data-id=".$rowPenjualan->idNota.">Belum Lunas</a></td>";
                      }
                      
                    }
                    if($rowPenjualan->status_kirim == "Menunggu"){
                      if($jabatan == "Gudang" || $jabatan == "Pemilik"){
                        echo "<td><a href=konfirmasikirimpenjualan.php?cmd=".$rowPenjualan->idNota.">".$rowPenjualan->status_kirim."</a></td>";
                      }
                      else{
                      ...
                      if($jabatan == "Gudang" || $jabatan == "Pemilik"){
                        echo "<td><a href=konfirmasikirimpenjualanfinal.php?cmd=".$rowPenjualan->idNota.">".$rowPenjualan->status_kirim."</a> - <a target='blank' href=halamanprint.php?cmd=".$rowPenjualan->idNota.">Print</a></td>";
                        
                      }
                      else{
                        echo "<td><a href=konfirmasikirimpenjualanfinal.php?cmd=".$rowPenjualan->idNota.">".$rowPenjualan->status_kirim."</a></td>";
                      }
